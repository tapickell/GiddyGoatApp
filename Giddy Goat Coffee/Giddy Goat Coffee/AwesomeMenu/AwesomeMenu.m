...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
        _addButton = [[AwesomeMenuItem alloc] initWithImage:[UIImage imageNamed:@"bg-menuButtonWithGoat.png"] highlightedImage:[UIImage imageNamed:@"big-green-button.png"] ContentImage:nil highlightedContentImage:nil];

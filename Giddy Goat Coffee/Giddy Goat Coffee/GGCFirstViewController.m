...
#pragma mark - menu display method
...
- (void)getMenuDisplay
{
    ...
    AwesomeMenuItem *menuItem3 = [[AwesomeMenuItem alloc] initWithImage:[UIImage imageNamed:itemBack] highlightedImage:nil ContentImage:[UIImage imageNamed:@"credit-card.png"] highlightedContentImage:nil];
...
- (void)AwesomeMenu:(AwesomeMenu *)menu didSelectIndex:(NSInteger)idx
{
    ...
    switch (idx) {
        ...
        case 2:
            //got to specials
            [self performSegueWithIdentifier:@"segueToCardFromSpecials" sender:self];
            break;
        case 3:
            //go to coffees
            [self performSegueWithIdentifier:@"specialsToCoffees" sender:self];
            break;
        case 4:
            //go to credits
            [self performSegueWithIdentifier:@"specialsToCredits" sender:self];
            break;
        case 5:
            //call giddy
            [self callPopup:self];
